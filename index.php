...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#personas">
                    Tipo Personas
                </button>

            </div>
        </div>
        <table id="tabla" class="table table-success table-striped"width:50%">
            <thead>
                <tr>
                    <th scope="col">ID</th>
    ...
    <div class="modal fade" id="form" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <center><h1>Agregar Persona</h1></center>
                    ...
                    <form action="insert.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <input name="nombre2" type="text" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="modal-footer">
                    <center><button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                    <button type="submit" class="btn btn-success">Guardar cambios</button></center>
                </div>
                </form>
            </div>
        </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="personas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tabla Tipo Personas</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <table id="tabla" class="table table-striped table-bordered table-condensed" style="width:100%">
                        ...
                        foreach ($result as $rows) :
                            echo "
                                    <tr>
                                    <td class='text-left'style='white-space: nowrap; width: 1px;'>$rows[id]</td>
                                    <td class='text-left'style='white-space: nowrap; width: 1px;'>$rows[tipo]</td>
                                    </tr>
                                    ";
                        endforeach;
                        ?>
